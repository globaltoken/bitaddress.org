(function (translator) {
	translator.translations["es"] = {
		...
		"paperlabelglobaltokenaddress": "Dirección Globaltoken:",
		...
		"brainalertpassphrasewarning": "Aviso: Es importante escoger una contraseña fuerte para evitar ataques de fuerza bruta a fin de adivinarla y robar tus globaltokens.",
		...
		"vanityalertinvalidinputcannotmultiple": "Entrada no válida. No se puede multiplicar dos claves públicas. Seleccione 'Añadir' para agregar dos claves públicas para obtener una dirección globaltoken.",
		...
		"tagline": "Generador de carteras Globaltoken de código abierto en lado de cliente con Javascript",
		"generatelabelglobaltokenaddress": "Generando dirección Globaltoken...",
		...
		"singlelabelglobaltokenaddress": "Dirección Globaltoken",
		...
		"bulklabelq1": "¿Por qué debo usar \"Direcciones en masa\" para aceptar Globaltokens en mi web?",
		"bulka1": "La forma tradicional de aceptar globaltokens en tu web requiere tener instalado el cliente oficial de globaltoken (\"globaltokend\"). Sin embargo muchos servicios de hosting no permiten instalar dicho cliente. Además, ejecutar el cliente en tu servidor supone que las claves privadas están también en el servidor y podrían ser comprometidas en caso de intrusión. Al usar este mecanismo, puedes subir al servidor sólo las dirección de globaltoken y no las claves privadas. De esta forma no te tienes que preocupar de que alguien robe la cartera si se cuelan en el servidor.",
		"bulklabelq2": "¿Cómo uso \"Direcciones en masa\" para aceptar globaltokens en mi web?",
		...
		"bulklabela2li3": "Ofrece una alternativa en el carro de la compra de tu web para que los clientes paguen con Globaltoken. Cuando el cliente elija pagar con Globaltoken, les muestras una de las direcciones de la base de datos como su \"dirección de pago\" y guardas esto junto con el pedido.",
		"bulklabela2li4": "Ahora te hace falta recibir una notificación del pago. Busca en google \"notificación de pagos globaltoken\" (o \"globaltoken payment notification\" en inglés) y suscríbete a alguno de los servicios que aparezcan. Hay varios de ellos, que te pueden notificar vía Web services, API, SMS, email, etc. Una vez te llegue la notificación, lo cual puede ser automatizado, entonces ya puedes procesar el pedido. Para comprobar a mano si has recibido un pago, puedes usar Block Explorer: reemplaza DIRECCION a continuación por la dirección que estés comprobando. La transacción puede tardar entre 10 minutos y una hora en ser confirmada. <br />http://www.blockexplorer.com/address/DIRECCION<br /><br />Puedes ver las transacciones sin confirmar en: http://blockchain.info/ <br />Las transacciones sin confirmar suelen aparecer ahí en unos 30 segundos.",
		"bulklabela2li5": "Las globaltokens que recibas se almacenarán de forma segura en la cadena de bloques. Usa la cartera original que generaste en el paso 1 para usarlas.",
		...
		"brainlabelglobaltokenaddress": "Dirección Globaltoken:",
		...
		"vanitylabelglobaltokenaddress": "Dirección Globaltoken personalizada:",
		"vanitylabelnotesglobaltokenaddress": "Esta es tu nueva dirección, que debería tener el prefijo deseado.",
		...
		"detaillabelnote2": "Globaltoken v0.6+ almacena las claves públicas comprimidas. El cliente también soporta importar/exportar claves privadas usando importprivkey/dumpprivkey. El formato de las claves privadas exportadas depende de si la dirección se generó en una cartera antigua o nueva.",
		"detaillabelglobaltokenaddress": "Dirección Globaltoken:",
		"detaillabelglobaltokenaddresscomp": "Dirección Globaltoken (comprimida):",
