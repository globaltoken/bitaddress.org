(function (translator) {
	translator.translations["ru"] = {
		...
		"paperlabelglobaltokenaddress": "Адрес Globaltoken кошелька:",
		...
		"generatelabelglobaltokenaddress": "Генерация Биткоин адреса...",
		...
		"singlelabelglobaltokenaddress": "Адрес Биткоин кошелька",
		...
		"brainlabelglobaltokenaddress": "Адрес Биткоин кошелька:",
		...
		"vanitylabelglobaltokenaddress": "Адрес Биткоин кошелька:",
		"vanitylabelnotesglobaltokenaddress": "Это Ваш новый адрес с префиксом.",
		...
		"detaillabelnote2": "Приложение Globaltoken версии 0.6 и выше хранит ключи в сжатом формате. Это приложение также поддерживает импорт и экспорт приватных ключей командами importprivkey/dumpprivkey. Формат экспортированного ключа определяется кошельком, который сгенерировал адрес Биткоин.",
		"detaillabelglobaltokenaddress": "Адрес Биткоин кошелька",
		"detaillabelglobaltokenaddresscomp": "Короткий адрес Биткоин кошелька",
